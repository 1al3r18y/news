...
const CHANNEL_URL = 'https://t.me/AjeelNewsIq';
...
export function mountCommunityWidget(): void {
  ...
  widget.innerHTML = `
    <div class="cw-pill">
      ...
      <span class="cw-text">انضم الى القناة العاجلة</span>
      <a class="cw-cta" href="${CHANNEL_URL}" target="_blank" rel="noopener">فتح القناة</a>
